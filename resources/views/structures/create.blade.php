...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Structure
                    <div class="page-title-subheading">This is an structure of UKMK Etalase</div>
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">Tambah structure</h5>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-10">
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="nia" id="nia" placeholder="Masukkan nia ..." type="text" class="form-control" value="{{ old('nia') }}">
                            </div>
                        </div>
                        <div class="position-relative row form-group">
                            <label for="nama" class="offset-sm-1 col-sm-2 col-form-label">Nama</label>
                            <div class="col-sm-9">
                                <input name="nama" id="nama" placeholder="Masukkan nama ..." type="text" class="form-control" value="{{ old('nama') }}">
                            </div>
                        </div>
                        <div class="position-relative row form-group">
                            <label for="jabatan" class="offset-sm-1 col-sm-2 col-form-label">Jabatan</label>
                            <div class="col-sm-9">
                                <input name="jabatan" id="jabatan" placeholder="Masukkan jabatan ..." type="text" class="form-control" value="{{ old('jabatan') }}">
                            </div>
                        </div>
                    </div>
                </div>
