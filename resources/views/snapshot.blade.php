...
<html lang="en">
  ...
  <link rel="stylesheet" href="{{ url('/') }}/assets/snapshot/{{ url('/') }}/assets/snapshot/css/open-iconic-bootstrap.min.css">
  ...
  <body>
  	...
  	<nav id="navbar" class="navbar">
		...
		<!-- Start Home Section -->
		<section id="home" class="hero-wrap js-fullheight" style="background-image:url({{ url('/') }}/assets/snapshot/images/bg-1.jpg);" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
    		...
    		<div class="row d-flex no-gutters">
    			<div class="col-md-6 col-lg-6 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img img-video d-flex align-self-stretch align-items-center" style="background-image:url({{ url('/') }}/assets/snapshot/images/about-2.jpg);">
        ...
        <div class="row progress-circle pt-md-5">
            ...
            <div class="row" style="margin-top: 40px">
              ...
              <div class="col-md-3"></div>
	        	...
	        	<div class="img w-100" style="background-image:url({{ url('/') }}/assets/snapshot/images/about-2.jpg);"></div>
	        </div>
		  	</div>
		  </div>
		</section>
        ...
        <div class="row no-gutters">
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-1.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-2.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-3.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-4.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-5.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-6.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-7.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-8.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-9.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-10.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-11.jpg);">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="model img d-flex align-items-end" style="background-image:url({{ url('/') }}/assets/snapshot/images/model-12.jpg);">
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-4" style="background-image:url({{ url('/') }}/assets/snapshot/images/person_1.jpg)">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-4" style="background-image:url({{ url('/') }}/assets/snapshot/images/person_2.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-4" style="background-image:url({{ url('/') }}/assets/snapshot/images/person_3.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
