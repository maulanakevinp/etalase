...
<div class="app-main__inner">
        ...
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <div class="d-inline-block dropdown">
                    <a href="{{ route('arts.create') }}" class="btn-shadow btn btn-info">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mt-5 mb-5">
            <a href="{{ route('arts.show', $art) }}" class="card-link">
                <div class="testimony-wrap p-4 pb-5">
                    <div class="user-img mb-4" style="background-image:url('{{ asset(Storage::url($art->gambar)) }}')">
                    <span class="quote d-flex align-items-center justify-content-center">
                            <i class="{{ $art->ikon }}"></i>
                        </span>
                    </div>
                    <div class="text">
                        <p class="mb-5 pl-4 line">{{$art->nama}}</p>
                        <div class="pl-5">
                            <p>{{$art->deskripsi}}</p>
                        </div>
                    </div>
